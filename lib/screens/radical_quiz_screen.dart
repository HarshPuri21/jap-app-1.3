...
class _RadicalQuizScreenState extends State<RadicalQuizScreen> {
  ...
  Widget _buildFeedback(RadicalQuestion r) {
    final correct = _selected == r.answer;
    return Padding(
      padding: const EdgeInsets.only(bottom: 12),
      child: Row(
  ...
  Widget _buildReveal(RadicalQuestion r) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          _readingRow('Name', r.name),
          _readingRow('Usage', r.usage),
              ...
              (ex) => Padding(
                ...
                child: Row(
                  children: [
                    SizedBox(
                      width: 50,
                      child: Text(ex.kanji, style: AppTheme.jp(18)),
                    ),
